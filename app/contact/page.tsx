        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-card rounded-lg p-6 border border-border">
              ...
              <a href="tel:+17855013414" className="text-primary hover:opacity-80 transition">(785) 501-3414</a>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 border border-border">
              ...
              <a href="mailto:topmobilesauna@gmail.com" className="text-primary hover:opacity-80 transition">topmobilesauna@gmail.com</a>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 border border-border">
              ...
              <p className="text-muted-foreground">3339 SW 34th Ct<br />Topeka, KS 66614</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              <h2 className="text-3xl font-bold mb-8 text-foreground">Hours & Info</h2>
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    We operate year-round with flexible scheduling to accommodate your lifestyle. Sessions available morning, afternoon, and evening.
                  </p>
                </div>

                <div>
                  <h3 className="font-bold text-lg mb-3 text-foreground">Service Area</h3>
                  <p className="text-muted-foreground">
                    We proudly serve Topeka, Kansas City, Overland Park, Lawrence, and surrounding areas throughout Kansas.
                  </p>
                </div>

                <div>
                  <h3 className="font-bold text-lg mb-3 text-foreground">Response Time</h3>
                  <p className="text-muted-foreground">
                    We respond to all inquiries within 24 hours. For urgent requests, please call directly.
                  </p>
                </div>
