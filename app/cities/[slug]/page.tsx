...
export default async function CityPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const cityData = {
    topeka: {
      name: "Topeka",
      title: "Mobile Sauna Rentals in Topeka",
      description: "Experience premium wellness in Topeka with BanyaHouse mobile sauna rentals",
      details: [
        "Our home base and primary service area",
        "Fast delivery and setup in Topeka",
        "Serving Topeka and surrounding communities",
        "Easy access and convenient scheduling",
      ],
    ...
    "kansas-city": {
      ...
      description: "Bring wellness to the Kansas City metropolitan area with BanyaHouse",
      details: [
    ...
    "overland-park": {
      ...
      description: "Premium sauna and cold plunge experiences in Overland Park",
      details: [
    ...
    lawrence: {
      ...
      description: "University town wellness services and rentals by BanyaHouse",
      details: [
      ...
      <main>
        <section className="py-12 md:py-16 bg-gradient-to-r from-primary to-primary/90 text-primary-foreground">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Area Not Found</h1>
          </div>
        </section>
      </main>
    )
    ...
    <main>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2">
              <h2 className="text-3xl font-bold mb-6">Why Choose BanyaHouse in {city.name}?</h2>
              ...
              <div className="mt-12 p-8 bg-muted/50 rounded-lg">
                ...
                <p className="text-muted-foreground mb-6">
                  Experience premium wellness with BanyaHouse. We deliver and setup everything for you.
                </p>
                <Link
                  href="/book"
            ...
            <div className="bg-card rounded-lg p-8 border border-border h-fit">
              ...
              <div className="space-y-6">
                <div className="flex gap-3">
                  <MapPin className="text-secondary mt-0.5 flex-shrink-0" size={20} />
                  <div>
                ...
                <div className="flex gap-3">
                  <Phone className="text-secondary mt-0.5 flex-shrink-0" size={20} />
                  <div>
                    <p className="font-semibold text-sm text-muted-foreground mb-1">Phone</p>
                    <a href={`tel:${city.phone}`} className="text-secondary hover:underline">
                      {city.phone}
                    </a>
                  </div>
                </div>
                <div className="flex gap-3">
                  <Mail className="text-secondary mt-0.5 flex-shrink-0" size={20} />
                  <div>
                    <p className="font-semibold text-sm text-muted-foreground mb-1">Email</p>
                    <a href={`mailto:${city.email}`} className="text-secondary hover:underline break-all">
                      {city.email}
                    </a>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 pt-12 border-t border-border">
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                Host a private escape at a time that works best for you. Our sauna accommodates 6 people with towels,
                hats, and lounging area included.
              </p>
              <h4 className="font-bold text-lg mb-2 mt-6">Delivered Experience</h4>
              <p className="text-muted-foreground">
                Perfect for parties, retreats, or extended sessions. We deliver, setup, and handle everything. Rental
                options from 2-4 hours to 3-day rentals.
              </p>
            </div>
      ...
      <section className="py-16 md:py-24 bg-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg opacity-90 mb-8">Book your sauna experience in {city.name} today.</p>
          <Link
            href="/book"
...
export async function generateStaticParams() {
  return [{ slug: "topeka" }, { slug: "kansas-city" }, { slug: "overland-park" }, { slug: "lawrence" }]
}
