      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-muted/50 rounded-xl p-8 mb-16">
            <h2 className="text-3xl font-bold mb-8 text-foreground">Setup & Requirements</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="font-bold text-xl mb-4 flex items-center gap-2 text-foreground">📍 Sauna Space Requirements</h3>
              ...
              <div>
                <h3 className="font-bold text-xl mb-4 flex items-center gap-2 text-foreground">💧 Cold Plunge Requirements</h3>
                <ul className="space-y-3 text-muted-foreground text-lg">
                ...
                <p className="text-base text-muted-foreground mt-4 italic">*Cold plunge is an optional add-on</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-xl p-8 border border-border">
            <h2 className="text-3xl font-bold mb-8 text-foreground">Rental Options & Add-Ons</h2>
            <div className="grid md:grid-cols-2 gap-8 mb-6">
              <div>
                <h3 className="font-bold text-xl mb-4 text-foreground">📅 Rental Durations</h3>
              ...
              <div>
                <h3 className="font-bold text-xl mb-4 text-foreground">➕ Optional Add-Ons</h3>
                <ul className="space-y-3 text-muted-foreground text-lg">
                  <li>• Cold plunge with ice setup</li>
                  <li>• Insulated dressing room</li>
                  <li>• Chairs</li>
                  <li>• Sauna attendant (tends the fire for a seamless experience)</li>
                </ul>
              </div>
            </div>

            <div className="bg-secondary/10 border border-secondary rounded-lg p-8 mt-6">
              <h3 className="font-bold text-xl mb-4 text-foreground">🕐 Delivery Schedule</h3>
              <p className="text-foreground mb-2 text-lg"><strong>Weekdays:</strong> Drop-off and pick-up after 4pm</p>
              <p className="text-foreground text-lg"><strong>Weekends:</strong> Flexible scheduling available anytime</p>
            </div>
          </div>
        </div>
      </section>
